...
run_dir=/data/xue/UFO/runs/PBFM_g1_fb_depth_canonical_plane_D001_lafan80_highknee20_no100style_8gpu_20260831_153026
...
exec .venv/bin/python scripts/watch_training_autoresume.py \
  ...
  --use-wandb \
  --wandb-project PBFM \
  --wandb-run-name PBFM_g1_fb_depth_canonical_plane_D001_lafan80_highknee20_no100style_8gpu_20260831_153026
